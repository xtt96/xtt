	...
	$(function(){
		TAOTAO.initItemCat({
			...
			$(".addGroupTr").hide().find(".param").remove();
				//  判断选择的目录是否已经添加过规格
			  $.getJSON("${pageContext.request.contextPath}/item/getItemParamByCatId/" + node.id,function(data){
		...
		$("#itemParamAddTable .submit").click(function(){
			...
			var url = "${pageContext.request.contextPath}/item/paramSave/"+$("#itemParamAddTable [name=cid]").val();
