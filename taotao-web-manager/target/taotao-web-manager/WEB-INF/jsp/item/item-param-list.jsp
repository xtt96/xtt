...
<table class="easyui-datagrid" id="itemParamList" title="商品列表" 
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'${pageContext.request.contextPath}/item/paramList',method:'get',pageSize:30,toolbar:itemParamListToolbar">
    <thead>
        <tr>
...
<script>
    ...
    var itemParamListToolbar = [{
        ...
        handler:function(){
        	TAOTAO.createWindow({
        		url : "${pageContext.request.contextPath}/item/item-param-add",
        	});
        }
    },{
        text:'编辑',
